...
I built a whole managed realtime infra called hela. five primitives, four sdks, two react apps, one elixir gateway, one elixir control plane, polar billing, terraform for railway, the works. i shipped 216 deployments to production. i archived it three days later.
